...
public class ShiroConfig {
    ...
    */
    ...
    public ShiroFilterFactoryBean shiroFilter(DefaultWebSecurityManager securityManager) {
        ...
        // 首页相关接口 - 允许匿名访问
        filterMap.put("/rotation/getApeRotationList", "anon");
        filterMap.put("/type/getApeVegetableTypeList", "anon");
        filterMap.put("/vegetable/getApeVegetableIndex", "anon");
        filterMap.put("/vegetable/getApeVegetableList", "anon");
        filterMap.put("/vegetable/getApeVegetableById", "anon");
